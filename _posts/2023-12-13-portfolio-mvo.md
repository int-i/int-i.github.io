...
**투자**에서 **수익률**은 투자자의 가장 중요한 목표 중 하나입니다.
...
최소-분산 포트폴리오를 찾기 위해서는 먼저 포트폴리오의 **기대수익률과 위험**을 **수학적으로 정의**해야 합니다.
...
> **(TMI) 분산투자의 효과**
>
> (2)식에서 $$\sigma_p^2$$는 아래와 같이 표현된다고 정리했습니다. 
>
...
이처럼 포트폴리오에 특정 종목이 치중해서 담기는 현상을 **과최적화 문제**라고 합니다.

현실에서는 이런 과최적화 문제를 해결하기 위해, **개별 종목에 비중 제한**을 두곤 합니다.
