...
그렇기에, 본인이 원하는 진로를 찾는 데 도움이 될 수 있도록 먼저 **학부 4학년** 수준에서 IT 업계가 앞으로 어떻게 변할지를 풀어보려 합니다.
...
구글이라는 **든든한 후원자**가 있었고 바둑으로 인간을 이기며 세간을 뒤흔들어 놓았음에도, 실질적으로 돈을 버는 데까지는 **5년**이 걸렸습니다.
...
학사4 년+군대 2년+석사 2년, 즉, 취직까지 최소 8년이 남았고, 8년이면 버블로 튀겨졌다가 침체 후 재평가를 받기까지 충분한 시간입니다.
...
**효율성의 문제**, **전투 방식의 변화**로 결국 **폐기**되었습니다.

막대한 예산을 들여서 만든 거대한 전함은 고철로 팔려나갔고요.
...
결국 **자율주행차**가 완성되려면 AI뿐만 아니라 **통신**, **배터리** 기술도 함께 발전해야 합니다.
